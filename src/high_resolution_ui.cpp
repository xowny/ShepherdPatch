...
constexpr std::array<PanelResolutionGroup, 25> kPanelGroups{{
    {640, 480, 0.50f, 300.0f, 490.0f, 0.0015812500116415321},
    {720, 576, 0.50f, 340.0f, 560.0f, 0.0012812500116415322},
    {800, 600, 0.75f, 380.0f, 580.0f, 0.0012812500116415322},
    {1024, 768, 0.75f, 490.0f, 790.0f, 0.0009812500116415323},
    {1152, 864, 0.75f, 550.0f, 910.0f, 0.0007812500116415322},
    {1280, 720, 0.75f, 670.0f, 940.0f, 0.0007812500116415322},
    {1280, 1024, 0.75f, 620.0f, 1030.0f, 0.0007812500116415322},
    {1360, 768, 0.75f, 660.0f, 1100.0f, 0.0007812500116415322},
    ...
    {2103, 1183, 1.00f, 1010.0f, 1750.0f, 0.0004062500116415322},
    {2350, 1323, 1.00f, 1130.0f, 1980.0f, 0.0004062500116415322},
    {2560, 1440, 1.00f, 1240.0f, 2170.0f, 0.0004062500116415322},
    {2715, 1527, 1.25f, 1300.0f, 2270.0f, 0.0002812500116415322},
    {2880, 1620, 1.25f, 1390.0f, 2420.0f, 0.0002812500116415322},
    {3325, 1871, 1.50f, 1600.0f, 2780.0f, 0.0002812500116415322},
    {3840, 2160, 1.50f, 1850.0f, 3260.0f, 0.0002812500116415322},
}};
} // namespace
    ...
    std::uint32_t width, std::uint32_t height)
{
    ...
    for (const auto& group : kPanelGroups)
    {
        ...
        {
            return {group.scale, group.offsetX, group.extentX, group.itemScale};
        }
    }
